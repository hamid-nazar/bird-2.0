...
public class MailConfiguration {
	...
	private static final String APPLICATION_NAME ="Bird";
	...
	private static final String CREDENTIAL_FILE_PATH = "/templates/credential.json";
	
	
	private Credential getCredential(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
		
		InputStream in = MailConfiguration.class.getResourceAsStream(CREDENTIAL_FILE_PATH);
